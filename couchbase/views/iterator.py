...
GeoRow = namedtuple('GeoRow', ['key', 'value', 'geometry', 'docid', 'doc'])
"""
...
class SpatialRowProcessor(RowProcessor):
    def __init__(self, rowclass=GeoRow):
...
class View(object):
    def __init__(self, parent, design, view, row_processor=None,
        ...
        Execute a spatial view::
            ...
            from couchbase.views.params import BBox, SpatialQuery
            # ....
            q = SpatialQuery()
            q.bbox = BBox(x1=-119.9556, y1=38.7056, x2=-118.8122, y2=39.7086)
