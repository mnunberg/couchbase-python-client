...
class MutationState(object):
    ...
    def _add_scanvec(self, mutinfo):
        ...
        self._sv.setdefault(bktname, {})[vb] = {
            'value': seq,
            'guard': str(uuid)
        }
    ...
    def add_result(self, rv, quiet=False):
        """
        ...
        :param rv: An :class:`~.OperationResult` which was returned as a
            result of a mutation
        :param quiet: Suppress errors if the result does not
...
class N1QLQuery(object):
    ...
    def consistent_with(self, state):
        ...
        self._body['scan_vector'] = state._sv
